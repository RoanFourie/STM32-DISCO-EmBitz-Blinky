...
LED_struct LED[] = {
  ...
  {LED_1,GPIOC,GPIO_Pin_9,RCC_APB2Periph_GPIOC,LED_OFF},    // PC9 = Green LED on Discovery Board
  {LED_2,GPIOC,GPIO_Pin_8,RCC_APB2Periph_GPIOC,LED_OFF},    // PC8 = Blue LED on Discovery Board
};
